...
const model = require("../../model/detail/m_detail_pengeluaran")
...
exports.getAllDetailPengeluaran = () =>
...
exports.getDetailPengeluaranById = (object_id) =>
  new Promise((resolve, reject) => {
    try {
      model
        .find({ objectIdPengeluaran: ObjectId(object_id) })
        .then((res) => {
          resolve(requestResponse.commonSuccessWithData(res))
        })
        .catch((e) => {
